...
# введенного пользователем слова. Будем считать, что на вход подается только
# одно слово, которое содержит либо только английские,
...
word = str(input("Введите слово: ")).upper()  # для всех вариантов


"""============================== Через цикл =============================="""
# score = 0
# for letter in word:
#     score += SCRABBLE_POINTS[letter]
#     print(f"Буква '{letter.upper()}' - {SCRABBLE_POINTS[letter]} очков")
# print(f"Всего очков: {score}")


"""============================ Через генератор ============================"""
score = sum(SCRABBLE_POINTS[letter] for letter in word)

print(*word, sep='   ')
print(*[SCRABBLE_POINTS[letter] for letter in word], sep=' + ')
print(f"Всего очков: {score}")
